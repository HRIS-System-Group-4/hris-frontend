        ...
        <CustomPage>
            ...
            <Card>
                <CardContent className="space-y-5">
                    <DetailGroup title="Employment Information">
                        <div className="flex items-center gap-2">
                            <Avatar className="h-16 w-16">
                                <AvatarImage
                                    src={data.employee.avatar || "/placeholder.svg"}
                            ...
                            <div>
                                ...
                                <div className="text-xs text-muted-foreground">{data.employee.email}</div>
                            </div>
                        </div>
                        <DetailContainer>
                            <DetailItem layout={"column"} label="Job Title">
                                <div className="font-medium text-black">UIUX Designer</div>
                            </DetailItem>
                    ...
                    <DetailGroup title="Attendance Detail">
                        <DetailContainer>
                ...
                {data.approval === "waiting" && (
                    <CardFooter className="flex justify-end border-t gap-4">
                        <Button variant="ghost" size={"lg"} className="bg-green-600 text-white hover:bg-green-700 hover:text-white">
                            <Check className="h-4 w-4" />
                            Approve
                        </Button>
                        <Button variant="ghost" size={"lg"} className="bg-neutral-100 text-red-600 hover:bg-neutral-200 hover:text-red-600">
                            <X className="h-4 w-4" />
                            Reject
                        </Button>
                    </CardFooter>
