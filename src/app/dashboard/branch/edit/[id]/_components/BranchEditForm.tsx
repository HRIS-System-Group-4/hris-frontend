...
import { getBranchDetail, updateBranch } from "@/services/branchService"
...
export default function EditBranchPage() {
    ...
    useEffect(() => {
        const fetchBranch = async () => {
            try {
                ...
                const branch = await getBranchDetail(params.id as string, token)
                ...
                toast({
                    ...
                    description: "Branch not found or an error occurred.",
                    variant: "destructive",
                })
            }
        }
    ...
    const handleConfirm = async () => {
            ...
            try {
                await updateBranch(params.id as string, {
                ...
                toast({
                    title: "Branch berhasil diperbarui",
                    description: "Data branch berhasil diupdate.",
                })

                router.push(`/dashboard/branch/${params.id}`)
            } catch (error) {
                toast({
    ...
    const handleSubmitCheck = async () => {
        ...
        if (isValid) {
            const values = form.getValues() // ✅ ambil data dari form
            setFormData(values)             // ✅ simpan ke formData
        ...
        <CustomPage>
            <CustomPageHeader>
                <CustomPageTitleContainer>
                    <CustomPageTitle>Edit Branch</CustomPageTitle>
            ...
            <Card className="w-full pt-0">
                <CardContent>
                    ...
                    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        <DialogContent>
                            <DialogHeader>
                                <DialogTitle className="text-lg font-semibold">Edit Branch</DialogTitle>
                                <DialogDescription>
                                    Please review the details below before editing the branch. Click Confirm to proceed or Cancel to edit.
                                </DialogDescription>
                            </DialogHeader>
